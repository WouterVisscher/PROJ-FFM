...
public class PJ_LOG_FUNCTION {
    ...
    private static final MethodHandle UP$MH = proj_h.upcallHandle(PJ_LOG_FUNCTION.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(PJ_LOG_FUNCTION.Function fi, Arena arena) {
