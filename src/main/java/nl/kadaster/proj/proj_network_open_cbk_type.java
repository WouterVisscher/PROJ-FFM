...
public class proj_network_open_cbk_type {
    ...
    public interface Function {
        MemorySegment apply(MemorySegment ctx, MemorySegment url, long offset, long size_to_read, MemorySegment buffer, MemorySegment out_size_read, long error_string_max_size, MemorySegment out_error_string, MemorySegment user_data);
    }
    ...
    private static final MethodHandle UP$MH = proj_h.upcallHandle(proj_network_open_cbk_type.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(proj_network_open_cbk_type.Function fi, Arena arena) {
